// Topojson world-atlas numeric IDs → ISO alpha-3
// Source: ISO 3166-1 numeric to alpha-3 mapping
export const numericToAlpha3: Record<string, string> = {
  ...
  "562": "NER", "566": "NGA", "807": "MKD", "578": "NOR", "512": "OMN",
  "586": "PAK", "585": "PLW", "591": "PAN", "598": "PNG", "600": "PRY",
  "604": "PER", "608": "PHL", "616": "POL", "620": "PRT", "634": "QAT",
  "642": "ROU", "643": "RUS", "646": "RWA", "659": "KNA", "662": "LCA",
  "670": "VCT", "882": "WSM", "674": "SMR", "678": "STP", "682": "SAU",
  ...
  "858": "URY", "860": "UZB", "548": "VUT", "336": "VAT", "862": "VEN",
  "704": "VNM", "887": "YEM", "894": "ZMB", "716": "ZWE",
  // Kosovo (not in ISO, some datasets use 383)
  "383": "XKX"
};

export function numericToId(numeric: string | number): string | undefined {
  // Topojson uses zero-padded strings ("076"), our keys use plain numbers ("76")
  const key = String(numeric).replace(/^0+/, '') || '0';
  return numericToAlpha3[key];
}
